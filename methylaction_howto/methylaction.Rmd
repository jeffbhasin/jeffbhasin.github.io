...
```{r,results='hide',warning=FALSE,message=FALSE,error=FALSE,fig.height=9,fig.width=7,dev=c('png', 'pdf')}
maHeatmap(ma)
```

```{r,results='hide',warning=FALSE,message=FALSE,error=FALSE,fig.height=2, fig.width=6,dev=c('png', 'pdf')}
