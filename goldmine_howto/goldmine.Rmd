...
```{r,results='hide',warning=FALSE,message=FALSE,error=FALSE,fig.height=4, fig.width=6,dev=c('pdf'),eval=TRUE}
...
```{r,results='hide',warning=FALSE,message=FALSE,error=FALSE,fig.height=6, fig.width=5,dev=c('pdf'),eval=TRUE}
