...
For Windows users only, ensure that Rtools has been installed. This requires an additional installation. Please see http://cran.r-project.org/bin/windows/Rtools/ to install Rtools for Windows.
